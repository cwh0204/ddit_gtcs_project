//src/domain/customs/import/constants/references.js
...
export const CHANNEL_DESCRIPTIONS = {
  GREEN: "서류/가격 모두 적정, 세액검토 후 즉시 통과",
  DOC: "추가 서류 제출 필요, 보완 후 재검토",
  ANALYSIS: "저가신고 또는 HS코드 의심, 가격평가 필요",
  RED: "현품 확인 필요, 검사 후 판정",
};

// 채널별 다음 상태
export const CHANNEL_NEXT_STATUS = {
  GREEN: "TAX_VERIFICATION",
