...
import { attachmentsApi } from "../../../../api/attachments/attachmentsApi"; // ⭐ 추가

// src/pages/customs/import/components/AttachmentsSection.jsx

/**
 * AttachmentsSection - 첨부파일 섹션
 * ⭐ needsReview=true일 때 인보이스, 패킹리스트, B/L, 기타첨부 각각 체크박스
 */
function AttachmentsSection({ essentialFiles, fileList, needsReview, checklist, onCheckChange }) {
