...
import { RISK_COLORS } from "../../domain/customs/export/exportConstants";
...
//src/pages/components/ExportDataGrid.jsx
function ExportDataGrid({ declarations, isLoading, onRowClicked, currentPage, totalPages, pageSize, onPageChange }) {
