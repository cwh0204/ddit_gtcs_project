...
<link rel="stylesheet" href="/css/shipper/information/complaint/complaint_detail.css">
...
<div class="container">
    ...
    <div class="local-header">
        <h2>민원사항</h2>
        <div class="breadcrumb">Home > 고객지원 > 민원사항</div>
    </div>
    ...
    <div class="info-table">
        ...
        <div class="info-row">
            ...
            <div class="info-value" id="fileList"></div>
        </div>
        <div class="info-row">
    ...
    <div class="detail-btn-group">
        <div id="btn-edit-group" style="display: none;">
            <button type="button" class="detail-btn delete">삭제</button>
            <button type="button" class="detail-btn edit">수정</button>
        </div>
        <a href="/client/information/complaint/complaint_list" class="detail-btn list">
            목록으로
        </a>
    </div>
    ...
    <div class="comment-area">
        <div class="comment-input-wrap">
            ...
            <button type="button" id="commentSubmitBtn" class="comment-submit-btn">등록하기</button>
        </div>
...
<script src="/js/shipper/information/complaint/complaint_detail.js"></script>