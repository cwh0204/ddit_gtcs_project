...
<link rel="stylesheet" href="/css/shipper/information/notice/noticelist.css">
...
<div class="container" style="padding: 30px; min-width: 1200px;">
    ...
    <div style="margin-bottom: 20px; display: flex; justify-content: space-between; align-items: flex-end;">
        <h2 style="color: #0f4c81; font-size: 20px; font-weight: bold; margin: 0;">공지사항</h2>
        <div style="font-size: 12px; color: #888;">Home > 정보센터 > 공지사항</div>
    </div>
    ...
    <div style="margin-bottom: 10px; font-size: 13px; color: #333; display: flex; justify-content: space-between; align-items: center;">
        <span>총 <b style="color: #0f4c81;" id="totalCount">0</b>건의 공지사항이 있습니다.</span>
    </div>
    

    <div id="noticeGrid" class="ag-theme-quartz"></div>
...
<script src="/js/shipper/information/notice/noticelist.js"></script>