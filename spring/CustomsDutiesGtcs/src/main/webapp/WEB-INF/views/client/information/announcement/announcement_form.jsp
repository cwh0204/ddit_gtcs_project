...
<link rel="stylesheet" href="/css/shipper/information/announcement/announcement_detail.css">
<!-- <link rel="stylesheet" href="/css/shipper/information/announcement/noticeform.css"> -->
...
<div class="container">
	...
	<div class="local-header">
		<h2>
			행정예고
			<c:out value="${empty notice ? '등록' : '수정'}" />
		</h2>
		<div class="breadcrumb">Home > 고객지원 > 행정예고</div>
	</div>

	<!-- form action 제거, method 제거 -->
...
<%-- 		<sec:csrfInput/> --%>
		...
		<c:if test="${not empty notice}">
			<input type="hidden" name="bdId" value="${notice.bdId}">
		</c:if>
		
		<input type="hidden" name="bdSecyn" value="N">
		<input type="hidden" name="bdType" value="행정예고">
			...
			<div class="write-row">
				...
				<div class="write-content">
					<input type="text" name="bdTitle" class="input-text"
						placeholder="제목을 입력해 주세요" value="${notice.bdTitle}" required>
				</div>
			</div>
			...
			<div class="write-row">
				...
				<div class="write-content">
					<input type="text" name="bdWriter" id="bdWriter" class="input-text"
						value="${notice.bdWriter}" readonly>
				</div>
			</div>
			...
			<div class="write-row">
				...
				<div class="write-content">
					<textarea name="bdCont" class="textarea-field" rows="15"
						placeholder="내용을 입력해 주세요" required>${notice.bdCont}</textarea>
				</div>
			</div>
			...
			<div class="write-row">
				...
				<div class="write-content">
					<div class="file-input-box">
						...
						<div id="newFileList" class="selected-file-list"
							style="border: none; background: none; padding: 0;"></div>
		...
		<div class="btn-groups">
            ...
            <button type="submit" class="btn-lookups">
                ...
                <c:out value="${empty notice ? '등록하기' : '수정하기'}" />
            </button>
...
<script src="/js/shipper/information/announcement/announcement_form.js"></script>