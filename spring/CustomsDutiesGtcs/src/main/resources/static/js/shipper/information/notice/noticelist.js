...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const response = await axios.get('/rest/board/list?bdType=공지사항', { headers });
...
function initGrid(rowData) {
    ...
    const gridOptions = {
        ...
        onRowClicked:  (event) => {
			...
			location.href = `/client/information/notice/noticedetail?bdId=${bdId}`;
        }
    };

    agGrid.createGrid(document.querySelector('#noticeGrid'), gridOptions);
}
